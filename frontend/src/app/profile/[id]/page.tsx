      ...
      <div className={styles.container}>
        <div className={styles.container__info}>
          ...
          <div className={styles.context}>
            <h1 className={styles.context__name}>
        ...
        <div className={styles.container__memories}>
          <div className={styles.memories}>
            ...
            <div className={styles.memories__list}>
              {user?.memories &&
                user.memories.map((memory: Memory, index: number) => (
                  <div className={styles.memory} key={index}>
                    <h4 className={styles.memory__location}>
                      {memory.city}, {memory.country}
                    </h4>
                    <h3 className={styles.memory__title}>{memory.title}</h3>
                    <p className={styles.memory__category}>
                      {memory.categoryName}
                    </p>
                    <p className={styles.memory__description}>
                      {memory.description}
                    </p>
                    <div className={styles.selector}>
                      <span className={styles.memory__likes}>
                        Likes: {memory.likeCount}
                      </span>
                      <span className={styles.memory__createdAt}>
